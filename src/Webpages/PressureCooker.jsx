...
export default function PressureCooker() {
  ...
  const handleSelection = (side) => {
    ...
    const choiceData = {
      ...
      winnerSide: side,
      winnerName:
        side === "left" ? currentPair.left.alt : currentPair.right.alt,
      ...
      {step === 0 ? (
        <Paper sx={{ p: 4, maxWidth: 500, mx: "auto", textAlign: "center" }}>
          ...
          <Typography variant="body1" sx={{ mb: 3, color: "text.secondary" }}>
            You have 3 seconds to choose! Build your streak by making quick
            decisions. Use <strong>Arrow Keys</strong> (← Left, → Right) or
            click to select.
          </Typography>
          <TextField
        ...
        <Box sx={{ position: "relative" }}>
          ...
          <Box
            sx={{
              ...
              fontSize: "1.2rem",
              boxShadow: 3,
              animation: isStreakHigh
                ? "shake 0.5s infinite, glow 1s infinite alternate"
                : "none",
              "@keyframes shake": {
