                ...
                return (
                  <>
                    ...
                    <TableRow sx={{ bgcolor: "#fafafa" }}>
                      <TableCell colSpan={2} sx={{ fontWeight: "bold", color: "#1976d2" }}>Session Average (No BM)</TableCell>
                      <TableCell align="right" sx={{ fontWeight: "bold", color: "#1976d2" }}>{avgScore}</TableCell>
                      <TableCell align="right" sx={{ fontWeight: "bold", color: "#1976d2" }}>{avgTime}</TableCell>
