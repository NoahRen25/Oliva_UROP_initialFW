-- Migration: restrict anon to SELECT + INSERT only, require auth for DELETE/UPDATE
...
-- Anon: read + insert only (participants submit results)
...
-- Authenticated: can delete/update (admin via Dataset Manager sign-in)
